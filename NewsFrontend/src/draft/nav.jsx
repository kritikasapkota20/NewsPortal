...
const Navbar = () => {
    ...
    return (
        <div className=''>
            <div className='w-full justify-between items-center px-6 md:px-12  py-0 pb-3 flex '>
                ...
                <div className='flex gap-0'>
                    ...
                    <p className='text-[ #388E3C] align-middle uppercase font-bold text-[65px] navatahead'>
                        <span className='text-[#0066B3] logo-gradient'>नवता
                            {/* <span className='logo-gradient'>न्युज</span> */}
                        </span>
            ...
            <div className='bg-[#0066B3]   width-full justify-between items-center md:px-12 px-6  py-3 text-[white] flex  '>
                <div className="noham ">
                    <ul className='flex justify-between items-center  text-white text-[17px] '>
                        ...
                        <Link to="/Artha"> <li className='hover:text-[#f0ddd7] cursor-pointer nav-link'>अर्थ</li></Link>
                        <Link to="/Bichar"> <li className='hover:text-[#f0ddd7] cursor-pointer nav-link'>बिचार</li></Link>
                        <Link to="/Swasthya"> <li className='hover:text-[#f0ddd7] cursor-pointer nav-link'>स्वास्थ्य</li></Link>
                        {/* <li className='hover:text-[] cursor-pointer nav-link'>जीवनशैली</li> */}
                        <Link to="/Manoranjan"> <li className='hover:text-[#f0ddd7] cursor-pointer nav-link'>मनोरञ्जन</li></Link>
