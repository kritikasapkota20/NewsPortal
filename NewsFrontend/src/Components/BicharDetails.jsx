...
//                 <h2 className="text-xl text-white font-bold">बिचार</h2>
//             </div>
...
//     <h2 className="text-xl text-[#F05922] font-bold whitespace-nowrap mr-4">बिचार</h2>
...
//                                 />
//                                 <div>
//                                     <Link to={`/BicharDetails/${item.title}`}>
