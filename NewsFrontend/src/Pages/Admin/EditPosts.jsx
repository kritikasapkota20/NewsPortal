...
const EditPost = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.patch(`http://localhost:5000/api/post/editPost/${formData.category}/${id}`, formDataToSend, {
                headers: {
    ...
    return (
        <div className='p-6 flex flex-col items-center'>
            ...
            <form onSubmit={handleSubmit} className='max-w-2xl bg-white p-6 rounded-lg shadow-2xl w-full'>
                ...
                {hasSubCategories && (
                    <div className='mb-4'>
                        <label className='block text-gray-700 text-base font-bold mb-2'>Sub Category:</label>
                        <select
                            name="subCategory"
                ...
                <div className='mb-4'>
                    ...
                    <textarea 
                        ...
                        onChange={handleChange} 
                        className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0065B3] text-decoration-none'
                        required
                    ></textarea>
                </div>
